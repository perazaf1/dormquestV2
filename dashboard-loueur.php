...
<body>
    ...
    <main class="dashboard-page">
        <div class="dashboard-container">
            ...
            <div class="alert alert-error" style="margin-bottom:12px;"><?php echo htmlspecialchars($_GET['error']); ?>
            </div>
            <?php endif; ?>
                ...
                <section class="dashboard-main">
                    ...
                    <div class="annonces-list">
                        ...
                        <article class="annonce-card">
                            <h3><a
                                    href="annonce.php?id=<?php echo (int)$a['id']; ?>"><?php echo htmlspecialchars($a['titre']); ?></a>
                            </h3>
                            <div class="muted"><?php echo htmlspecialchars($a['ville']); ?> —
                                <?php echo number_format($a['prixMensuel'],0,',',' '); ?> €</div>
                            <div class="muted" style="font-size:0.85rem;margin-top:6px;">Publiée le
                                <?php echo htmlspecialchars($a['dateCreation']); ?></div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a
                                        href="annonce.php?id=<?php echo (int)$c['annonce_id']; ?>"><?php echo htmlspecialchars($c['annonce_titre']); ?></a>
                                </td>
                                <td>
                                    ...
                                    <div style="display:flex;align-items:center;gap:8px;">
                                        ...
                                        <button type="button" class="btn-link view-message"
                                            data-student="<?php echo htmlspecialchars($c['etu_prenom'] . ' ' . $c['etu_nom'], ENT_QUOTES); ?>"
                                            data-annonce="<?php echo htmlspecialchars($c['annonce_titre'], ENT_QUOTES); ?>"
                                            data-message="<?php echo htmlspecialchars($c['message'], ENT_QUOTES); ?>">Voir</button>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="api/candidature-action.php"
                                    ...
                                    <form method="POST" action="api/candidature-action.php"
                                        style="display:inline-block;" onsubmit="return confirmAction(this)">
                                        <?php csrf_field(); ?>
                                        <input type="hidden" name="id" value="<?php echo (int)$c['id']; ?>">
                ...
                <aside class="dashboard-aside">
                    <div class="card">
                        ...
                        <ul class="fav-list">
                            ...
                            <li>
                                <div>
                                    <strong><?php echo htmlspecialchars($fa['etu_prenom'] . ' ' . $fa['etu_nom']); ?></strong>
                                    <div class="muted">a ajouté aux favoris : <a
                                            href="annonce.php?id=<?php echo (int)$fa['idAnnonce']; ?>"><?php echo htmlspecialchars($fa['annonce_titre']); ?></a>
                                    </div>
                                    <div class="muted" style="font-size:0.85rem;margin-top:6px;">Le
                                        <?php echo htmlspecialchars($fa['dateAjout']); ?></div>
                                </div>
                            </li>
                            <?php endforeach; ?>
                        </ul>
