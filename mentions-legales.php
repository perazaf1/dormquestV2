        ...
        <div class="legal__container">
            ...
            <section id="hebergeur" class="legal__section">
                ...
                <div class="legal__text">
                    ...
                    Site web : <a href="https://www.ovhcloud.com" target="_blank"
                        rel="noopener noreferrer">www.ovhcloud.com</a>
                </div>
            </section>
            ...
            <section id="realisation" class="legal__section">
                ...
                <div class="legal__text">
                    Design, intégration et développement réalisés par <strong>Nyzer</strong> dans le cadre du projet
                    étudiant <strong>DormQuest</strong>.
                </div>
            </section>
            ...
            <section id="conditions" class="legal__section">
                ...
                <div class="legal__text">
                    L’utilisation du site <strong>DormQuest</strong> implique l’acceptation pleine et entière des <a
                        href="CGU.php">Conditions Générales d’Utilisation (CGU)</a>.
                    Les utilisateurs du site s’engagent à accéder au site en utilisant un matériel récent, ne contenant
            ...
            <section id="donnees" class="legal__section">
                ...
                <div class="legal__text">
                    Les informations recueillies sur le site <strong>DormQuest</strong> font l’objet d’un traitement
                    destiné à assurer le bon fonctionnement du service.
                    DormQuest s’engage à ne jamais vendre ni céder ces données à des tiers.
                    Pour plus d’informations sur la collecte et le traitement de vos données personnelles, consultez la
                    section <a href="CGU.php#donnees">« Données personnelles »</a> de nos CGU.
                    Vous disposez des droits d’accès, de rectification, de suppression, d’opposition et de portabilité
            ...
            <section id="cookies" class="legal__section">
                ...
                <div class="legal__text">
                    Le site <strong>DormQuest</strong> utilise des cookies techniques nécessaires à son fonctionnement
                    et des cookies de mesure d’audience anonymisés.
                    Vous pouvez refuser le dépôt des cookies non essentiels via le bandeau de gestion des cookies lors
                    de votre première visite ou depuis les paramètres de votre navigateur.
                </div>
            </section>
            ...
            <section id="propriete" class="legal__section">
                ...
                <div class="legal__text">
                    Tous les éléments du site <strong>DormQuest</strong> (textes, images, graphismes, logo, structure,
                    code source) sont protégés par le droit d’auteur et la propriété intellectuelle.
            ...
            <section id="liens" class="legal__section">
                ...
                <div class="legal__text">
                    Le site <strong>DormQuest</strong> peut contenir des liens vers d’autres sites. DormQuest n’exerce
                    aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu.
                    La création de liens vers le site DormQuest est autorisée uniquement dans le respect de la
                    législation en vigueur et à condition de ne pas porter atteinte à son image.
                </div>
            </section>
            ...
            <section id="droit" class="legal__section">
                ...
                <div class="legal__text">
                    ...
                    En cas de litige, et après échec de toute tentative de résolution amiable, les tribunaux français
            ...
            <p class="legal__small" style="margin-top:1.5rem;">
                Note : ces mentions légales sont fournies à titre informatif. Pour une conformité complète, prévoir une
